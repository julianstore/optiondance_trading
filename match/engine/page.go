...
type Entry struct {
	...
	list   *arraylist.List
	orders map[string]*core.EngineOrder
}
...
func (page *Page) Put(order *core.EngineOrder) {
	...
	if !found {
		entry = &Entry{
			...
			Funds:  number.Zero(),
			list:   arraylist.New(),
			orders: make(map[string]*core.EngineOrder),
		}
...
func (page *Page) Remove(o *core.EngineOrder) *core.EngineOrder {
	if page.Side != o.Side {
		return nil
	}
...
func (page *Page) Iterate(hook func(*core.EngineOrder) (number.Integer, number.Integer, bool)) {
